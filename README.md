...
- ⏱️ **시간 중복 제거**: 같은 작업자의 겹치는 작업 시간 자동 병합 (Multi-job 대응)
...
- [x] **작업자 상세 모달**: 작업자 클릭 시 상세 정보, 차트, 작업 이력 표시
- [x] 공정별 평균 작업률 차트
- [x] 성과 등급 분포 도넛 차트
- [x] 날짜별 피벗 리포트
- [x] 상세 데이터 뷰
...
- **최신 배포**: https://c3c2fe2b.mes-r018-analysis.pages.dev
